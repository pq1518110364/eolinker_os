...
public interface ApiMapper
{
	...
	//删除分组下的接口
	public Integer deleteApiByGroupID(@Param("groupID") Integer groupID, @Param("removeTime") Timestamp removeTime);
	...
	public List<Map<String, Object>> getApiList(@Param("projectID") Integer projectID,
			@Param("groupID") Integer groupID, @Param("orderBy") String orderBy);
