...
public class DatabaseTableFieldController
{
	...
	public Map<String, Object> addField(DatabaseTableField databaseTableField)
	{
		...
		else if (databaseTableField.getFieldDescription() == null || (databaseTableField.getFieldDescription() != null
				&& !(databaseTableField.getFieldDescription().length() >= 1
						&& databaseTableField.getFieldDescription().length() <= 255)))
		{
			map.put("statusCode", "240005");
			return map;
		}
		else
		{
