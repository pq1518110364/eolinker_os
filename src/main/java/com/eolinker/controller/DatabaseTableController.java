...
public class DatabaseTableController
{
			...
			@RequestParam(value = "tableDescription", required = false) String tableDesc)
	{
		...
		try
		{
			...
			else if (tableDesc != null && !(tableDesc.length() > 1 && tableDesc.length() < 255))
